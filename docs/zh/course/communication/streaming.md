...
前三种模式处理的都是"一条条独立的消息"。但小莫的语音、视频这类数据不一样——它们是**连续不断的流**：一句话由很多个字连着蹦出来，一段视频由很多帧连着播。而且，你还得能**随时打断**它（比如小莫正说着话，你插一句，它得马上停下来听你的）。
...
流式最有价值的能力是**打断**。想象小莫正在逐字念一大段话，你突然说话——它必须**立刻停下**，并把"还没念出口、正排队等着的那些字"全部**扔掉**，转而处理你的新指令。
