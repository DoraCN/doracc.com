...
Service 适合"一问一答、立刻能答"的事。但如果小多要做的是一件**很耗时**的事呢？比如"走到门口"——这得走好几秒。要是用 Service，小多就得**傻等到走完才收到一个"到了"**，中间毫无音讯，也没法喊停。
...
:::tip 为什么取消很重要？
真实机器人里，"取消"是安全刚需。比如小多正伸手去抓杯子，你突然喊停——必须能立刻中止，否则可能撞坏东西。Action 天生支持这种"随时喊停"，这是它比 Service 更适合真实动作任务的关键原因。
:::
