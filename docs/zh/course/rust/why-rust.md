...
前面八章，小多身上所有零件都是 Python 写的。Python 好写、好懂、AI 生态最全——但它有个小短板：**算得不够快**。当某些零件需要"每秒处理成千上万次"时，Python 就有点吃力了。

这一章，我们给小多请来一位"心算高手"帮忙：**Rust**。它能让关键零件跑得飞快，让小多真正**💪 变强壮**。
...
小多有下面几个节点，你觉得哪些**值得**考虑用 Rust 写，哪些用 Python 就好？说说理由。
