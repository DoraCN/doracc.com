...
**DORA 中文社区** 是面向中文开发者的 DORA 学习、交流与共建家园。DORA（Dataflow-Oriented Robotic Architecture）是一个为 AI 时代打造的高性能机器人开发框架，比 ROS2 更快、更简单、更懂 AI。我们希望把最好的中文教程、最热情的交流氛围和最开放的共建机制带给每一个对机器人感兴趣的人。

> 我们的目标：让"用 DORA 做机器人"这件事，对中文世界的每个人都**触手可及**。

**我们提供：**

- **系统的中文课程**：面向开发者的《从零开始学 DORA》，以及参考式的《DORA 基础教程》。
- **权威资料导航**：DORA 官网中文文档、源码仓库、示例工程。
- **活跃的交流渠道**：官方微信群、公众号，以及 GitHub 的 Issues / Discussions。
- **开放的共建机制**：欢迎贡献教程、示例、勘误与建议，人人既是使用者也是共建者。

**社区特点：** 技术驱动、生态共建、新兴且活跃。随着具身智能（Embodied AI）浪潮，社区正快速成长。欢迎你加入！🤖
...
|------|------|------|
| ⭐️ 社区门户首页 | `/` | 品牌与两门课程入口 |
| 🌱 从零开始学 DORA | `/course/*` | 项目驱动课程（基于 DORA 1.0 RC） |
...
- **从零开始学 DORA**（`/course/`）：面向开发者，循序渐进完成 8 个小项目，直到用 VLM 完成"看见并抓取"的毕业项目。基于 **DORA 1.0 RC 源码编译**；软件为主、不强依赖 GPU。
